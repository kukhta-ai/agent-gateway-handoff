...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 The drive and resume architecture is confirmed to cover inspecting after a window closes, or the delta is specified; nothing already covered is re-specified.
