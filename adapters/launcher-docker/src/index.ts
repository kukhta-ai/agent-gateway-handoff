// @gla/launcher-docker — adapter ring (baseline §1).
// ALT Launcher: container T4 (stub).
...
export const LAUNCHER_DOCKER_MODULE = "@gla/launcher-docker" as const;

/** Ring classification from the architecture baseline (informational). */
export const LAUNCHER_DOCKER_RING = "adapter" as const;
