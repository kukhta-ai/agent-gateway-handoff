...
// `https://57.131.31.126/`). It composes ONE shared app state (`createProvisioningBridge` with the handoff +
...
export interface ServeOptions {
  ...
  /**
   * The PUBLIC base URL handoff/enroll links are built against, e.g. `https://57.131.31.126/`. Threaded into
