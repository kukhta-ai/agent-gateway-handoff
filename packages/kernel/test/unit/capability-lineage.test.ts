...
import type { CapabilityId, Iso8601, RecipientRef } from "../../src/brands.js";
import type { OpaqueToken } from "../../src/brands.js";
import { InMemoryRevocations } from "../../src/capability.js";
import type { Caveat } from "../../src/caveats.js";
import { HmacCapabilitySigner } from "../../src/hmac-signer.js";
...
describe("auth.scope_required maps to the auth exit code", async () => {
  const { exitCodeFor, ExitCode } = await import("../../src/errors.js");
